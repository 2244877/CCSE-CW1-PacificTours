    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TourBooking_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    User_Id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Tour_Id = table.Column<int>(type: "int", nullable: false),
                    CheckInDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tourbookings", x => x.TourBooking_Id);
                    table.ForeignKey(
                        name: "FK_tourbookings_tours_Tour_Id",
                        column: x => x.Tour_Id,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "600b4a6a-76f7-4771-ba4f-e03734dded11", null, "client", "client" },
                    { "748c31a5-a85f-4441-9355-f31e9f277c4f", null, "admin", "admin" },
                    { "c478bf2f-274e-4bc9-8d70-d8c68c100eb1", null, "seller", "seller" }
                });
